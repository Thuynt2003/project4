...
const ListTeachingAssignment = () => {
    ...
    const dataTeachingAssignment = teachers.map((data) => ({
        ...
        key: data.id,
        Stt: data.id,
        Giao_Vien: data.user.userDetail.lastname + data.user.userDetail.lastname,
    ...
    console.log('dataTeachingAssignment:', teachers);
    return (
        <>
            <div style={{ width: "100%" }}>
...
export default ListTeachingAssignment